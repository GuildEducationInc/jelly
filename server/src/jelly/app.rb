...
module Jelly
  class App < ::Sinatra::Base
    ...
    helpers do
      def current_user
        @current_user ||= ::Jelly::Services::Users::Current.call request
      end
    end
    ...
    before do
      ...
      ::Jelly::Redis.logger = logger
      ::Wolverine.config.redis = ::Jelly::Redis.instance.client
    end
    ...
    post '/graphql' do
      ...
      result = ::Jelly::GraphQL::Schema.execute(
        body['query'],
